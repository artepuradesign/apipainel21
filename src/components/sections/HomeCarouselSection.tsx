...
const homeCarouselContent: Record<Locale, HomeCarouselContent> = {
  'pt-BR': {
    ...
    slides: [
      ...
      {
        title: 'Painel de Consultas via API',
      ...
      {
        title: 'Loja Virtual Fácil e Rápida',
        subtitle: 'Publique sua loja online em poucos cliques',
        description: 'Transforme seu catálogo em uma vitrine pública pronta para vender sem complicação técnica.',
        image: slide04,
      },
      {
